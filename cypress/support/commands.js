...
Cypress.Commands.add('generateRandomWords', (count = 5) => {
  const words = [
    ...
    'forest', 'guitar', 'hello', 'island', 'jungle',
    'kangaroo', 'lemon', 'mountain', 'ocean', 'penguin',
    'queen', 'river', 'sunset', 'tiger', 'umbrella',
    'violin', 'waterfall', 'xylophone', 'yellow', 'zebra',
    'airplane', 'butterfly', 'castle', 'diamond', 'energy',
    'freedom', 'galaxy', 'harmony', 'infinity', 'journey',
    'knowledge', 'lightning', 'melody', 'nature', 'adventure',
    'butterfly', 'creative', 'discover', 'exciting', 'fantastic',
    'gorgeous', 'happiness', 'inspiring', 'joyful', 'kindness',
    'laughter', 'miracle', 'optimism', 'peaceful', 'radiant',
    'sunshine', 'triumph', 'universe', 'victory', 'wonderful',
    'anchor', 'blizzard', 'canyon', 'dolphin', 'ember',
    'falcon', 'glacier', 'harvest', 'illusion', 'jasmine',
    'keystone', 'labyrinth', 'meteor', 'nebula', 'oasis',
    'paradise', 'quartz', 'rainbow', 'safari', 'temple',
    'utopia', 'voyage', 'whirlpool', 'xenon', 'yearning',
    'zephyr', 'alchemy', 'bravery', 'compass', 'destiny',
    'enigma', 'firefly', 'gravity', 'heartbeat', 'icicle',
    'jubilee', 'karma', 'legend', 'mirage', 'nebulae',
    'odyssey', 'pinnacle', 'quiver', 'resonance', 'serenity',
    'twilight', 'uplift', 'valor', 'wisdom', 'zenith'
  ];
